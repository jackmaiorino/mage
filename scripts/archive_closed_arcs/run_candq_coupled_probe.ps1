...
$trainEnv = {
  ...
  $env:CANDIDATE_Q_FROM_MCTS_TARGETS="1"; $env:CANDIDATE_Q_LOSS_COEF="0.5"   # 10x: real encoder gradient
  ...
  $env:REFERENCE_POLICY_KL_COEF="0.3"   # light: slows collapse, does not freeze the encoder
  $env:MCTS_REFERENCE_MODEL_PATH="C:/Users/Jack/IdeaProjects/mage/local-training/backups/ref_frozen_0573.pt"
  $env:CANDIDATE_Q_DUMP_DIR="C:/Users/Jack/IdeaProjects/mage/local-training/candq_dumps_v8"
