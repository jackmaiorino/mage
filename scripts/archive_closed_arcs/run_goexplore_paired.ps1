...
"=== GOEXPLORE PAIRED $(Get-Date) ===" | Out-File $out
...
# paired phase params
$env:GOEXPLORE_PHASE="convert_paired"
$env:GOEXPLORE_HARVEST_GAMES="300"
$env:GOEXPLORE_TARGET_ROOTS="50"
...
"=== GOEXPLORE PAIRED DONE $(Get-Date) ===" | Out-File $out -Append
Kill-Train
