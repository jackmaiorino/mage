...
$out  = "local-training/goexplore_convert_RESULT.log"
...
"=== GOEXPLORE CONVERT $(Get-Date) ===" | Out-File $out
...
$env:RL_ONLINE_PREFIX_SEARCH_MAX_DEPTH="14"
$env:RL_ONLINE_PREFIX_SEARCH_MAX_NODES="600"
$env:RL_ONLINE_PREFIX_SEARCH_TOP_K="4"
$env:RL_ONLINE_PREFIX_SEARCH_MAX_ACTIVATIONS="30"
$env:RL_ONLINE_PREFIX_SEARCH_TOTAL_TIMEOUT_MS="10000"
$env:RL_ONLINE_PREFIX_SEARCH_BRANCH_TIMEOUT_MS="4000"
$env:GOEXPLORE_PHASE="probe"
$env:GOEXPLORE_TRIALS="40"
...
"=== GOEXPLORE CONVERT DONE $(Get-Date) ===" | Out-File $out -Append
Kill-Train
