...
"=== GOEXPLORE WINPOS $(Get-Date) ===" | Out-File $out
...
$env:GOEXPLORE_PHASE="winpos"
$env:GOEXPLORE_HARVEST_GAMES="150"
$env:GOEXPLORE_TARGET_ROOTS="40"
...
"=== GOEXPLORE WINPOS DONE $(Get-Date) ===" | Out-File $out -Append
Kill-Train
