...
$out  = "local-training/goexplore_frontier_RESULT.log"
...
"=== GOEXPLORE FRONTIER $(Get-Date) ===" | Out-File $out
...
$env:GOEXPLORE_PHASE="frontier_bench"
$env:GOEXPLORE_HARVEST_GAMES="60"
$env:GOEXPLORE_TARGET_ROOTS="15"
$env:GOEXPLORE_EPISODE_TAG="0"
$env:GOEXPLORE_SEED_BASE="7777"

$env:GOEXPLORE_ROLLOUTS_PER="6"
...
"=== GOEXPLORE FRONTIER DONE $(Get-Date) ===" | Out-File $out -Append
Kill-Train
