...
$log  = "local-training/affinity_slope.log"
...
$env:DECK_LIST_FILE="$deckDir/decklist.affinity_rallyelves.txt"   # weighted opponent pool
...
$env:TOTAL_EPISODES="9000"                             # chunk 1
$env:GAME_LOG_FREQUENCY="2000"
$env:RL_HEURISTIC_STEP_REWARDS="0"                      # terminal-only reward (thesis)

"=== AFFINITY SLOPE (warm-start, weighted diet, CP7 skill1) $(Get-Date) ===" | Out-File $log
...
"=== AFFINITY SLOPE DONE $(Get-Date) ===" | Out-File $log -Append
